export type Jupiter = {
  ...
  instructions: [
    ...
    },
    {
      ...
      args: [{ name: 'id'; type: 'u8' }, { name: 'burn_all'; type: 'bool' }];
    },
    {
      ...
      accounts: [
        {
          ...
          pda: {
            seeds: [
              ...
              { kind: 'account'; path: 'market' },
              { kind: 'account'; path: 'program_authority' }
            ];
          };
        },
        { name: 'payer'; writable: true; signer: true },
    ...
    },
    {
      ...
      type: {
        ...
        fields: [
          {
            name: 'accounts_type';
            type: { defined: { name: 'AccountsType' } };
          },
          { name: 'length'; type: 'u8' }
        ];
      };
...
export const jupiterIdl: Jupiter = {
  address: 'JUP6LkbZbjS1jKKwapdHNy74zcZ3tLUZoi5QNyVTaV4',
  metadata: {
    name: 'jupiter',
    version: '0.1.0',
